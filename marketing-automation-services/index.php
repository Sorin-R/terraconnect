...
<head><meta charset="UTF-8" />
    ...
    <title>Marketing Automation Services — Terra Connect | London</title>
    <meta name="description"
        content="Marketing automation services in London. Terra Connect builds AI-powered email, lead nurturing, segmentation, campaign automation, and reporting workflows." />
    <meta name="keywords"
...
media="print" onload="this.media='all'" />
    ...
    <link rel="stylesheet" href="/styles/pages/marketing-automation-services.css" />
        ...
        <main id="main">
            <section class="hero">
                ...
                <div class="hero-cta">
                    ...
                    <a class="btn secondary focus-ring" href="/contacts/">Talk to a Specialist</a>
                </div>
            </section>
                ...
                <section class="content-section">
                    ...
                    <div class="process-grid">
                        <div class="process-step">
                            ...
                            <h3 class="step-title">Lead Nurturing</h3>
                            <p class="step-description">Build multi-step email and SMS journeys that convert cold leads
                                into qualified opportunities.</p>
                        </div>
                        <div class="process-step">
                            <div class="step-number">2</div>
                            <h3 class="step-title">Campaign Automation</h3>
                            <p class="step-description">Trigger campaigns from form submissions, page views, events, and
                                product interactions.</p>
                        </div>
                        <div class="process-step">
                            <div class="step-number">3</div>
                            <h3 class="step-title">Lead Scoring</h3>
                            <p class="step-description">Score contacts by engagement and intent to prioritize high-value
                                leads for sales teams.</p>
                        </div>
                        <div class="process-step">
                            <div class="step-number">4</div>
                            <h3 class="step-title">Reactivation Flows</h3>
                            <p class="step-description">Automatically re-engage inactive subscribers and recover
                                opportunities before they go cold.</p>
                        </div>
                        <div class="process-step">
                            <div class="step-number">5</div>
                            <h3 class="step-title">Personalization at Scale</h3>
                            <p class="step-description">Use dynamic content and AI insights to tailor messages by
                                segment, interest, and stage.</p>
                        </div>
                        <div class="process-step">
                            <div class="step-number">6</div>
                            <h3 class="step-title">Reporting Automation</h3>
                            <p class="step-description">Track channel and campaign performance in one place with
                                automated executive reporting.</p>
                        </div>
                    </div>
                </section>
