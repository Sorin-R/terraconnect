    ...
    <main id="main">
        <div class="content-section" style="max-width:900px;margin:0 auto 40px;padding:60px 40px;">
            ...
            <ul>
                ...
                <li>Specific (you know what you are consenting to receive)</li>
                <li>Informed (we tell you who we are and what we will send)</li>
            ...
            <ul>
                ...
                <li>We are marketing similar products or services to those you previously purchased or enquired about</li>
                <li>You were given a clear opportunity to opt out at the time of collection, and you did not opt out</li>
            ...
            <ul>
                ...
                <li>Conceal our identity in commercial communications</li>
                <li>Omit our postal address from marketing emails</li>
                <li>Send marketing by SMS or phone without prior express consent</li>
                <li>Continue to market to you after you have unsubscribed</li>
            ...
            <ul>
                ...
                <li>Our registered address: 57 Tonbridge Drive, Basildon, SS15 6ND, UK</li>
