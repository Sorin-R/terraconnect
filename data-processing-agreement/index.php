    ...
    <main id="main">
        <div class="content-section inline-style-1">
            ...
            <ul>
                ...
                <li><strong>&ldquo;Processor&rdquo;</strong> means Terra Connect Ltd, who processes personal data on behalf of the Controller</li>
                <li><strong>&ldquo;Personal Data&rdquo;</strong> has the meaning given in the UK GDPR</li>
                <li><strong>&ldquo;Processing&rdquo;</strong> has the meaning given in the UK GDPR</li>
                <li><strong>&ldquo;Data Subject&rdquo;</strong> means any identified or identifiable natural person whose personal data is processed</li>
                <li><strong>&ldquo;Sub-processor&rdquo;</strong> means any third party engaged by the Processor to carry out processing activities on behalf of the Controller</li>
            ...
            <ul>
                ...
                <li>Ensure that persons authorised to process personal data have committed to confidentiality or are under an appropriate statutory obligation of confidentiality</li>
                <li>Implement appropriate technical and organisational security measures as required by UK GDPR Article 32</li>
                <li>Not engage sub-processors without the Controller&rsquo;s prior written authorisation (general or specific)</li>
                <li>Assist the Controller in responding to data subject requests within the timeframes required by UK GDPR (generally one calendar month)</li>
                <li>Assist the Controller in meeting its obligations under UK GDPR Articles 32&ndash;36 (security, breach notification, DPIAs)</li>
                <li>Delete or return all personal data to the Controller at the end of the service provision, at the Controller&rsquo;s election</li>
            ...
            <ul>
                ...
                <li><strong>Access control:</strong> Role-based access controls; only authorised personnel can access client data</li>
                <li><strong>Pseudonymisation:</strong> Applied where appropriate to reduce risk</li>
                <li><strong>Confidentiality:</strong> All staff and contractors are bound by confidentiality agreements</li>
                <li><strong>Availability &amp; resilience:</strong> Regular backups and disaster recovery procedures</li>
                <li><strong>Testing:</strong> Regular security assessments and vulnerability testing</li>
