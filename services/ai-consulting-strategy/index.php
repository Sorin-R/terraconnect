...
<head><meta charset="UTF-8" />
    ...
    <title>AI Consulting and Strategy Services — Terra Connect</title>
    ...
    <meta name="twitter:title" content="AI Consulting and Strategy Services — Terra Connect" />
    <meta name="twitter:description" content="AI consulting and strategy services for organizations that need practical roadmaps, use-case validation, and implementation planning." />
        ...
        <main id="main">
            <section class="hero" aria-labelledby="service-heading">
                <div class="hero-text">
                    ...
                    <p class="hero-p">Plan AI adoption with clarity and business alignment.<br>Validate use cases before full-scale implementation.<br>Build practical roadmaps tied to measurable outcomes.</p>
                </div>
            </section>

            <section class="service-wrap" aria-label="Service details">
                <div class="service-intro">
                    <p>AI consulting and strategy services for organizations that need practical roadmaps, use-case validation, and implementation planning.</p>
                </div>
                ...
                <article class="service-section">
                    ...
                    <ul class="deliver-list">
                        <li>AI opportunity assessment and prioritization workshops</li>
                        <li>Tool selection, architecture planning, and risk review</li>
                        <li>Pilot design with metrics and success criteria</li>
                        <li>Implementation roadmap with governance recommendations</li>
