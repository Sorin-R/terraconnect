...
<head><meta charset="UTF-8" />
    ...
    <title>Custom Software Development Services — Terra Connect</title>
    ...
    <meta name="twitter:title" content="Custom Software Development Services — Terra Connect" />
    <meta name="twitter:description" content="Custom software development services tailored to business processes, helping teams replace manual workflows with scalable digital systems." />
        ...
        <main id="main">
            <section class="hero" aria-labelledby="service-heading">
                <div class="hero-text">
                    ...
                    <p class="hero-p">Turn complex operations into software that scales.<br>Design systems aligned to real business workflows.<br>Deliver maintainable solutions with measurable outcomes.</p>
                </div>
            </section>

            <section class="service-wrap" aria-label="Service details">
                <div class="service-intro">
                    <p>Custom software development services tailored to business processes, helping teams replace manual workflows with scalable digital systems.</p>
                </div>
                ...
                <article class="service-section">
                    ...
                    <ul class="deliver-list">
                        <li>Bespoke system architecture for business-specific needs</li>
                        <li>Workflow automation and integration with existing tools</li>
                        <li>Security-first engineering and performance optimization</li>
                        <li>Documentation, onboarding, and post-launch evolution</li>
